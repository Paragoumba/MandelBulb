...
void ParamsManager::importSettings(std::string path) {
    ...
    setHideMenu((bool)j["hideMenu"]);
    setShowExportMenu((bool)j["showExportMenu"]);
    std::string t(j["reA"]);
    setReA(t.c_str());
    t = std::string(j["imA"]);
    setImA(t.c_str());
...
void ParamsManager::exportSettings(std::string path) {
    ...
    j["hideMenu"] = getHideMenu();
    j["showExportMenu"] = getShowExportMenu();
    j["reA"] = getReA();
    j["imA"] = getImA();
    j["reC"] = getReC();
    j["imC"] = getImC();
